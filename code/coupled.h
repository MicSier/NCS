...
double coupled_get_gamma0(double* (*f)(double,double,double,double,double,double,double,double,double,double*,double*,int,int,bool),double Vs,double Vt,double nl,double tp,double sxt,double syt,double sxc,double syc,double xk[],double ak[],int n,int k,bool isfromsinglet,double a,double b);
